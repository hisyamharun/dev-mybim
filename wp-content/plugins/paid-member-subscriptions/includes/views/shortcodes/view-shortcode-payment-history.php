...
<table id="pms-payment-history" class="pms-table">
    ...
    <tbody>
        <?php foreach( $payments as $payment ): ?>
            <tr>
                <td class="pms-payment-id"><?php echo '#' . $payment->id; ?></td>
                <td class="pms-payment-amount"><?php echo pms_get_currency_symbol( pms_get_active_currency() ) . $payment->amount; ?></td>
                ...
                <td class="pms-payment-status"><?php echo ucfirst( $payment->status ); ?></td>
            </tr>
        <?php endforeach; ?>
