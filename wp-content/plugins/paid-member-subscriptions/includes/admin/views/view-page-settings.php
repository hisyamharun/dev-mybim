                    ...
                    if( count( $payment_gateways ) > 1 ) {
                        ...
                        echo '<div class="pms-form-field-wrapper pms-form-field-active-payment-gateways">';
                            ...
                            foreach( $payment_gateways as $payment_gateway_slug => $payment_gateways_details ) {
                                echo '<label>';
                                echo '<input type="checkbox" name="pms_settings[payments][active_pay_gates][]" value="' . $payment_gateway_slug . '" ' . ( !empty( $this->options['payments']['active_pay_gates'] ) && in_array( $payment_gateway_slug, $this->options['payments']['active_pay_gates'] ) ? 'checked="checked"' : '' ) . '/>';
