                ...
                if ($pms_version_validation != -1) {
                    ...
                    if (in_array(strtolower($version), $pms_add_on['product_version_type'])) {
                        ...
                        if ($pms_add_on_exists) {
                            ...
                            echo '<a target="_blank" class="right button button-primary" href="' . $pms_add_on['url'] . $pms_paid_href_utm_text . '" data-add-on-slug="paid-member-subscriptions-' . $pms_add_on['slug'] . '" data-add-on-name="' . $pms_add_on['name'] . '" data-nonce="' . $ajax_nonce . '">' . __('Learn More', 'paid-member-subscriptions') . '</a>';
