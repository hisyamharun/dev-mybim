	...
	if ($screen->id === 'settings_page_dashboard_widgets_suite') {
		...
		if (isset($_GET['reset-options'])) {
			...
			if ($_GET['reset-options'] === 'true') : ?>
				...
				<div class="notice notice-success is-dismissible"><p><?php esc_html_e('Default options restored.', 'dashboard-widgets-suite'); ?></p></div>
				
			<?php else : ?>
				
				<div class="notice notice-info is-dismissible"><p><?php esc_html_e('No changes made to options.', 'dashboard-widgets-suite'); ?></p></div>
			...
			if ($_GET['delete-notes'] === 'true') : ?>
				...
				<div class="notice notice-success is-dismissible"><p><?php esc_html_e('All User Notes deleted.', 'dashboard-widgets-suite'); ?></p></div>
				
			<?php else : ?>
				
				<div class="notice notice-info is-dismissible"><p><?php esc_html_e('No changes made to User Notes.', 'dashboard-widgets-suite'); ?></p></div>
