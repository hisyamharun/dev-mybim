...
function dashboard_widgets_suite_section_notes_user() {
	...
	echo esc_html__('Double-click on any note on the Dashboard to edit.', 'dashboard-widgets-suite') .'</p>';
...
function dashboard_widgets_suite_callback_rate($args) {
	...
	$href  = 'http://wordpress.org/support/view/plugin-reviews/'. DWS_SLUG .'?rate=5#postform';
	...
	echo '<a target="_blank" class="dws-rate-plugin" href="'. $href .'" title="'. $title .'">'. $text .'</a>';
