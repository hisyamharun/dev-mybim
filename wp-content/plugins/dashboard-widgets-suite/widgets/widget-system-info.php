...
function dashboard_widgets_suite_get_wp_update_methods() {
	...
	$filesystem_message = $filesystem_method !== 'direct' ? esc_html__('FTP/SSH access only', 'usp') : esc_html__('Direct access allowed', 'usp');
...
function dashboard_widgets_suite_get_database_infos() { ?>
	...
	<ul>
		...
		<li><?php esc_html_e('SQL: ',      'dashboard-widgets-suite'); echo dashboard_widgets_suite_get_database_client_version(); ?></li>
...
function dashboard_widgets_suite_check_security() { ?>
	...
	<ul>
		...
		<li><?php esc_html_e('Magic Quotes: ',      'dashboard-widgets-suite'); echo dashboard_widgets_suite_check_magic_quotes(); ?></li>
