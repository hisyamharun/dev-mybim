...
function dashboard_widgets_suite_log_debug() {
	...
	if (file_exists($log_file)) {
		...
		if ($errors) {
			...
			echo '<p><span class="fa fa-search"></span> '. esc_html__('Showing the latest ', 'dashboard-widgets-suite') . $item_count .' of '. sprintf(_n('%s error.', '%s errors.', $lines, 'dashboard-widgets-suite'), $lines);
