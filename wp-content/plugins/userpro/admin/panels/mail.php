...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td><textarea name="mail_userpro_connect_request" id="mail_userpro_connect_request" class="large-text code" rows="10"><?php echo userpro_get_option('mail_userpro_connect_request'); ?></textarea></td>
	</tr>
