...
<h3><i class="userpro-icon-gears"></i><?php _e('Compatibility Settings-Null24.Net','userpro'); ?></h3>
<table class="form-table">
...
<tr valign="top">
		<th scope="row"><label for="categorie_selection"><?php _e('Front end publisher category selection','userpro'); ?></label></th>
		<td>
