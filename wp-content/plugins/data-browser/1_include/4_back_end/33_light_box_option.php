...
if ( ! function_exists( 'ws_db_single_post_light_box_option' ) ) {
	function ws_db_single_post_light_box_option($all_setting)
	{
		
	?>
	<span  style="display:none" >
			<div id="ws_db_single_post_light_box_option" style="background-color:white;padding: 38px 20px;" >
				<div class="ws_db_setting_section ws_db_single_post_light_box_option211x" style="margin-bottom:30px" >
